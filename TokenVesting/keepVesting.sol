...
contract keepVesting is Ownable{

    BEP20 private keepToken;
    ...
    /*  Sets the token that will be vested by this Smart Contract. 
        It should be called as soon as the keep token is deployed.
    */

    function setkeepTokenAddress(address _keepTokenAddress) external onlyOwner{
        keepToken = BEP20(_keepTokenAddress);
    }
    ...
    function distributeTokens() external{
        ...
        if(currentTime > SEED_CLIFF){
            ...
            for(uint i = 0; i < seedSaleBuyers.length; i++){
                ...
                keepToken.transfer(receiver, availableTokensSeed);
        ...
        if(currentTime > PRIVATE_CLIFF){
            ...
            for(uint i = 0; i < privateSaleBuyers.length; i++){
                ...
                keepToken.transfer(receiver, availableTokensPrivate);
